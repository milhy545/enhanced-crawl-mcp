...
class TestEdgeCases:
    ...
    def test_timeout_handling(self, mock_crawler_class, client):
        ...
        mock_instance.crawl.side_effect = TimeoutError()
        mock_instance.__aenter__.return_value = mock_instance
        mock_instance.__aexit__.return_value = None
        mock_crawler_class.return_value = mock_instance

        response = client.post("/crawl", json={"url": "https://slow-website.com", "timeout": 5})
    ...
    def test_concurrent_requests(self, mock_crawler_class, client):
        ...
        mock_result = CrawlResult(url="https://example.com", markdown="# Test", success=True)
